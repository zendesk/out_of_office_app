module.exports = {
    ...
    'toggle_status': function(agentID) {this.updateStatus(agentID); this.switchTo('loading');},
    ...
    //'init.done': function(){this.render();}, //unlock rendering since we are starting fresh
    ...
    'getAllAgentsByGroup.fail': function() {this.renderRetry();},
    ...
    'getAllAgentsByGroup.done': function() {this.renderRetries = 0;},
