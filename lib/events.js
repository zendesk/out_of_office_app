module.exports = {
    ...
    'click .toggleswitch-checkbox': function(evt) {evt.preventDefault();this.verifyChange(evt);},
    ...
    'ticket.submit.always': function() {var that = this; this.timeout = setTimeout(function() {that.lockRender = false;}, 500);}, //this will unlock rendering 500ms after the ticket has been saved. Tweak the value if you see froze/incorrect results in  the ticket sidebar.
    'app.willDestroy': function() {if(this.timeout) {clearTimeout(this.timeout);}},
    ...
    'tag_progress': function(evt) {this.render();},
    'change #filter_groups': function() {this.require('ui', this.options).filterByGroup();},

    // Notifications
    'start_tagging': function(evt) {this.render();},
    ...
    'getAllGroups.fail': function() {this.renderRetry();},
    'getSingleAgent.fail': function() {this.renderRetry();},
    'setStatus.fail': function() {this.renderRetry();},
    'applyTag.fail': function() {this.renderRetry();},
    ...
    'getAllGroups.done': function() {this.renderRetries = 0;},
    'getSingleAgent.done': function() {this.renderRetries = 0;},

    //support link redirect
    'click #get_support_button': 'showSupportLink'
};
