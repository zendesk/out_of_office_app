var AWS = require('utils/aws-sdk');

AWS.config.update({accessKeyId: 'AKIAJR5E63XD6GXEWHKA', secretAccessKey: '***REMOVED***'}); //I should mention that these credentials *only* have Lambda execute permissions, nothing else (and so should be safe to expose)
