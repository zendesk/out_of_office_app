...
module.exports = {
    ...
    loadSettings: function() {
        ...
        app.when(util.getTriggerID(), util.getUserFieldID(), util.getInstallationID()).done(function(trigger, field, installation) {
            if ((trigger === undefined && util.settings.createTrigger === true) || field === undefined){
                util.installApp().done(function(trigger, field) {
                    app.trigger('created_requirements', {settings: util.settings});        
                    util.settings.triggerID = trigger;
                    util.settings.installed = true;
                    app.trigger('loaded_settings', {settings: util.settings});        
                });
            } else { 
                util.settings.triggerID = trigger;
                util.settings.installed = true;
