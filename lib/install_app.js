    ...
    installApp: function() {
        return util.appFramework.promise(function(done, fail) {
            ...
            util.appFramework.when(
                ...
                if(trigger1 !== undefined && trigger2 !== undefined && field !== undefined) {
                    done();
                } 
                ...
                util.appFramework.when(requests).done(function() {done();}).fail(function() {
                    util.appFramework.trigger('functional_error', {type: 'installApp'});
                });
            });
        }).fail(function() {
            util.appFramework.trigger('functional_error', {type: 'findObject'});
        });
    }
